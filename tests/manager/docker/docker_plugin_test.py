...
@mock.patch("src.Kathara.manager.docker.DockerPlugin.DockerPlugin._get_xtables_lock_mount")
@mock.patch("src.Kathara.setting.Setting.Setting.get_instance")
def test_check_and_download_vde_plugin_not_enabled(mock_setting_get_instance, mock_get_xtables_lock_mount,
                                                   mock_configure_xtables_mount, docker_plugin, mock_plugin,
                                                   mock_setting):
    ...
    docker_plugin.client.plugins.get.return_value = mock_plugin
    docker_plugin.check_and_download_plugin()
    docker_plugin.client.plugins.get.assert_called_once_with("kathara/katharanp_vde:" + utils.get_architecture())
    mock_plugin.upgrade.assert_called_once()
    mock_plugin.enable.assert_called_once()
    assert not mock_get_xtables_lock_mount.called
    assert not mock_configure_xtables_mount.called
...
@mock.patch("src.Kathara.manager.docker.DockerPlugin.DockerPlugin._get_xtables_lock_mount")
@mock.patch("src.Kathara.setting.Setting.Setting.get_instance")
def test_check_and_download_vde_plugin_enabled(mock_setting_get_instance, mock_get_xtables_lock_mount,
                                               mock_configure_xtables_mount, docker_plugin, mock_plugin, mock_setting):
    mock_setting.network_plugin = "kathara/katharanp_vde"
    mock_setting_get_instance.return_value = mock_setting
    mock_plugin.enabled = True
...
@mock.patch("src.Kathara.manager.docker.DockerPlugin.DockerPlugin._get_xtables_lock_mount")
@mock.patch("src.Kathara.setting.Setting.Setting.get_instance")
def test_check_and_download_vde_plugin_not_found(mock_setting_get_instance, mock_get_xtables_lock_mount,
                                                 docker_plugin, mock_plugin, mock_setting):
    mock_setting.network_plugin = "kathara/katharanp_vde"
    mock_setting_get_instance.return_value = mock_setting
    docker_plugin.client.plugins.get.return_value = None
...
@mock.patch("src.Kathara.manager.docker.DockerPlugin.DockerPlugin._get_xtables_lock_mount")
@mock.patch("src.Kathara.setting.Setting.Setting.get_instance")
def test_check_and_download_remote_vde_plugin_not_installed(mock_setting_get_instance, mock_get_xtables_lock_mount,
                                                            mock_configure_xtables_mount, docker_plugin, mock_plugin,
                                                            mock_setting):
    mock_setting.network_plugin = "kathara/katharanp_vde"
    mock_setting.remote_url = "http://remote-url.kt"
...
@mock.patch("src.Kathara.manager.docker.DockerPlugin.DockerPlugin._get_xtables_lock_mount")
@mock.patch("src.Kathara.setting.Setting.Setting.get_instance")
def test_check_and_download_remote_vde_plugin_not_enabled(mock_setting_get_instance, mock_get_xtables_lock_mount,
                                                          mock_configure_xtables_mount, docker_plugin, mock_plugin,
                                                          mock_setting):
    mock_setting.network_plugin = "kathara/katharanp_vde"
    mock_setting.remote_url = "http://remote-url.kt"
