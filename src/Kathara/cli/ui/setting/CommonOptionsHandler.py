...
class CommonOptionsHandler(OptionsHandler):
    def add_items(self, current_menu: ConsoleMenu, menu_formatter: MenuFormatBuilder) -> None:
        ...
        select_image_menu = SelectionMenu(
            ...
            prologue_text="""Default Docker image when you start a network scenario or a single Kathara device.
        ...
        open_terminals_menu.append_item(
            FunctionItem(
                text="Yes",
                function=setting_utils.update_setting_value,
        ...
        machine_shell_menu = SelectionMenu(
            ...
            prologue_text="""The shell to use inside the device.
                          ...
                          **The application must be correctly installed in the Docker image used for the device!**
                          ...
                          Default is `%s`, but it depends on the used Docker image.""" % DEFAULTS['device_shell']
        )
        ...
        debug_level_menu = SelectionMenu(
            strings=[],
        ...
        print_startup_log_menu = SelectionMenu(
            strings=[],
            title=open_terminals_string,
            ...
            prologue_text="""When opening a device terminal, print its startup log.
                          ...
                          Default is %s.""" % setting_utils.format_bool(DEFAULTS['print_startup_log'])
        )

        print_startup_log_menu.append_item(
            FunctionItem(
                text="Yes",
                function=setting_utils.update_setting_value,
        ...
        enable_ipv6_menu = SelectionMenu(
            strings=[],
            ...
            prologue_text="""This option enables IPv6 inside the devices.
                          ...
                          Default is %s.""" % setting_utils.format_bool(DEFAULTS['enable_ipv6'])
        )

        enable_ipv6_menu.append_item(
            FunctionItem(
                text="Yes",
                function=setting_utils.update_setting_value,
